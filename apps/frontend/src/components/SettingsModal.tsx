...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  ...
  }, [confirmRevokeId, isOpen, onClose]);
  ...
  }, [aiAssistant, isOpen, loadMcpTokens]);
  ...
  return (
    ...
    >
      <FocusTrap focusTrapOptions={{ allowOutsideClick: true }}>
        <div
          ref={modalRef}
          className="max-h-[90vh] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-6 shadow-xl animate-slide-in-up"
        >
            ...
            <section>
              ...
              <div className="space-y-4 rounded-lg bg-gray-50 p-4">
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() => void handleToggle("dates", !userFlags.dates)}
                ...
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() =>
                      void handleToggle("delegation", !userFlags.delegation)
                    }
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className={`
                      ...
                      ${saving || !available.ai_assistant ? "cursor-not-allowed opacity-50" : ""}
                    `}
                    role="switch"
